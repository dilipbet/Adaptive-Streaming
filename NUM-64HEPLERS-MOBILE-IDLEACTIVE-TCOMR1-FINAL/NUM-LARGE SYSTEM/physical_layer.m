function[cap_mat,cap_bs,zz,active_links,zz_bs,total_symbols]=physical_layer(z_h,z_u,macro_side,cell_side,helpers_per_cell,...
    users_per_cell,W_lte,W_wifi,freq_reuse,T,no_helper)
