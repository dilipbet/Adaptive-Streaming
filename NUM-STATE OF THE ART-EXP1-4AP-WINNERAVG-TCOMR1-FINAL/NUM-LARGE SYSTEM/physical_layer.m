function[cap_mat,cap_bs,active_links,zz_bs,helper_user_distance,helper_user_strength,...
    ...
    users_per_cell,W_lte,W_wifi,freq_reuse,T,no_helper,num_helpers,num_users)
